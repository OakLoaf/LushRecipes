...
public class RecipeAPI {
    ...
    private RecipeAPI(JavaPlugin plugin, Map<NamespacedKey, CraftingRecipe> recipes, boolean showInRecipeBook) {
    ...
    public void registerRecipe(NamespacedKey key, CraftingRecipe recipe) {
    ...
    public static class Builder {
        ...
        public Builder shouldShowInRecipeBook(boolean showInRecipeBook) {
            this.showInRecipeBook = showInRecipeBook;
            return this;
        }

        public RecipeAPI build() {
            return new RecipeAPI(this.plugin, this.recipes, this.showInRecipeBook);
        }
    }
}
